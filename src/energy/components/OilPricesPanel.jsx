...
import MetricChartOverlay from '@shared/components/MetricChartOverlay';
...
// Reuse the same overlay pattern as M&A MetricChartOverlay but for YF symbols
...
function CommodityChartOverlay({ symbol, title, onClose }) {
            ...
            <>
              ...
              <ResponsiveContainer width="100%" height={160}>
                <LineChart data={chartData} margin={{ top: 4, right: 4, bottom: 2, left: -12 }}>
                  ...
                  <Tooltip />
                  <Line type="monotone" dataKey="value" stroke="#DCB96E" strokeWidth={1.5} dot={false} activeDot={{ r: 3, fill: '#DCB96E' }} />
                </LineChart>
              </ResponsiveContainer>
            </>
          )}
